...
namespace AutoGestao.Migrations
{
    ...
    [Migration("20250920042028_Novidades")]
            ...
            modelBuilder.Entity("AutoGestao.Entidades.Avaliacao", b =>
                {
                    ...
                    b.Property<DateTime>("DataAlteracao")
                        ...
                        .HasDefaultValue(new DateTime(2025, 9, 20, 4, 20, 28, 269, DateTimeKind.Utc).AddTicks(9748))
            ...
            modelBuilder.Entity("AutoGestao.Entidades.Cliente", b =>
                {
                    ...
                    b.Property<DateTime>("DataAlteracao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 9, 20, 4, 20, 28, 269, DateTimeKind.Utc).AddTicks(4298))
                        .HasColumnName("data_alteracao");
            ...
            modelBuilder.Entity("AutoGestao.Entidades.Despesa", b =>
                {
                    ...
                    b.Property<DateTime>("DataAlteracao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 9, 20, 4, 20, 28, 270, DateTimeKind.Utc).AddTicks(138))
                        .HasColumnName("data_alteracao");
            ...
            modelBuilder.Entity("AutoGestao.Entidades.DespesaTipo", b =>
                {
                    ...
                    b.Property<DateTime>("DataAlteracao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 9, 20, 4, 20, 28, 270, DateTimeKind.Utc).AddTicks(382))
                        .HasColumnName("data_alteracao");
            ...
            modelBuilder.Entity("AutoGestao.Entidades.Fornecedor", b =>
                {
                    ...
                    b.Property<DateTime>("DataAlteracao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 9, 20, 4, 20, 28, 269, DateTimeKind.Utc).AddTicks(5858))
                        .HasColumnName("data_alteracao");
            ...
            modelBuilder.Entity("AutoGestao.Entidades.Parcela", b =>
                {
                    ...
                    b.Property<DateTime>("DataAlteracao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 9, 20, 4, 20, 28, 269, DateTimeKind.Utc).AddTicks(9341))
                        .HasColumnName("data_alteracao");
            ...
            modelBuilder.Entity("AutoGestao.Entidades.Tarefa", b =>
                {
                    ...
                    b.Property<DateTime>("DataAlteracao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 9, 20, 4, 20, 28, 270, DateTimeKind.Utc).AddTicks(703))
                        .HasColumnName("data_alteracao");
            ...
            modelBuilder.Entity("AutoGestao.Entidades.Veiculos.Veiculo", b =>
                {
                    ...
                    b.Property<DateTime>("DataAlteracao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 9, 20, 4, 20, 28, 269, DateTimeKind.Utc).AddTicks(7110))
                        .HasColumnName("data_alteracao");
            ...
            modelBuilder.Entity("AutoGestao.Entidades.Veiculos.VeiculoDocumento", b =>
                {
                    ...
                    b.Property<DateTime>("DataAlteracao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 9, 20, 4, 20, 28, 269, DateTimeKind.Utc).AddTicks(8418))
                        .HasColumnName("data_alteracao");
            ...
            modelBuilder.Entity("AutoGestao.Entidades.Veiculos.VeiculoFoto", b =>
                {
                    ...
                    b.Property<DateTime>("DataAlteracao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 9, 20, 4, 20, 28, 269, DateTimeKind.Utc).AddTicks(8081))
                        .HasColumnName("data_alteracao");
            ...
            modelBuilder.Entity("AutoGestao.Entidades.Venda", b =>
                {
                    ...
                    b.Property<DateTime>("DataAlteracao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 9, 20, 4, 20, 28, 269, DateTimeKind.Utc).AddTicks(8854))
                        .HasColumnName("data_alteracao");
            ...
            modelBuilder.Entity("AutoGestao.Entidades.Vendedor", b =>
                {
                    ...
                    b.Property<DateTime>("DataAlteracao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 9, 20, 4, 20, 28, 269, DateTimeKind.Utc).AddTicks(5062))
                        .HasColumnName("data_alteracao");
