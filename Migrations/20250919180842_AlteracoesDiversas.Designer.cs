...
namespace AutoGestao.Migrations
{
    ...
    [Migration("20250919180842_AlteracoesDiversas")]
    partial class AlteracoesDiversas
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AutoGestao.Entidades.Avaliacao", b =>
                {
                    ...
                    b.Property<DateTime>("DataAlteracao")
                        ...
                        .HasDefaultValue(new DateTime(2025, 9, 19, 18, 8, 42, 85, DateTimeKind.Utc).AddTicks(3297))
            ...
            modelBuilder.Entity("AutoGestao.Entidades.Cliente", b =>
                {
                    ...
                    b.Property<DateTime>("DataAlteracao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 9, 19, 18, 8, 42, 84, DateTimeKind.Utc).AddTicks(7429))
                        .HasColumnName("data_alteracao");
            ...
            modelBuilder.Entity("AutoGestao.Entidades.Despesa", b =>
                {
                    ...
                    b.Property<DateTime>("DataAlteracao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 9, 19, 18, 8, 42, 85, DateTimeKind.Utc).AddTicks(3767))
                        .HasColumnName("data_alteracao");
            ...
            modelBuilder.Entity("AutoGestao.Entidades.DespesaTipo", b =>
                {
                    ...
                    b.Property<DateTime>("DataAlteracao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 9, 19, 18, 8, 42, 85, DateTimeKind.Utc).AddTicks(4024))
                        .HasColumnName("data_alteracao");
            ...
            modelBuilder.Entity("AutoGestao.Entidades.Fornecedor", b =>
                {
                    ...
                    b.Property<DateTime>("DataAlteracao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 9, 19, 18, 8, 42, 84, DateTimeKind.Utc).AddTicks(9092))
                        .HasColumnName("data_alteracao");
            ...
            modelBuilder.Entity("AutoGestao.Entidades.Parcela", b =>
                {
                    ...
                    b.Property<DateTime>("DataAlteracao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 9, 19, 18, 8, 42, 85, DateTimeKind.Utc).AddTicks(2837))
                        .HasColumnName("data_alteracao");
            ...
            modelBuilder.Entity("AutoGestao.Entidades.Tarefa", b =>
                {
                    ...
                    b.Property<DateTime>("DataAlteracao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 9, 19, 18, 8, 42, 85, DateTimeKind.Utc).AddTicks(4405))
                        .HasColumnName("data_alteracao");
            ...
            modelBuilder.Entity("AutoGestao.Entidades.Veiculos.Veiculo", b =>
                {
                    ...
                    b.Property<DateTime>("DataAlteracao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 9, 19, 18, 8, 42, 85, DateTimeKind.Utc).AddTicks(386))
                        .HasColumnName("data_alteracao");
            ...
            modelBuilder.Entity("AutoGestao.Entidades.Veiculos.VeiculoDocumento", b =>
                {
                    ...
                    b.Property<DateTime>("DataAlteracao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 9, 19, 18, 8, 42, 85, DateTimeKind.Utc).AddTicks(1872))
                        .HasColumnName("data_alteracao");
            ...
            modelBuilder.Entity("AutoGestao.Entidades.Veiculos.VeiculoFoto", b =>
                {
                    ...
                    b.Property<DateTime>("DataAlteracao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 9, 19, 18, 8, 42, 85, DateTimeKind.Utc).AddTicks(1490))
                        .HasColumnName("data_alteracao");
            ...
            modelBuilder.Entity("AutoGestao.Entidades.Venda", b =>
                {
                    ...
                    b.Property<DateTime>("DataAlteracao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 9, 19, 18, 8, 42, 85, DateTimeKind.Utc).AddTicks(2300))
                        .HasColumnName("data_alteracao");
            ...
            modelBuilder.Entity("AutoGestao.Entidades.Vendedor", b =>
                {
                    ...
                    b.Property<DateTime>("DataAlteracao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 9, 19, 18, 8, 42, 84, DateTimeKind.Utc).AddTicks(8225))
                        .HasColumnName("data_alteracao");
