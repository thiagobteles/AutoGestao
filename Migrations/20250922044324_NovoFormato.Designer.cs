...
namespace AutoGestao.Migrations
{
    ...
    [Migration("20250922044324_NovoFormato")]
    partial class NovoFormato
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AutoGestao.Entidades.Avaliacao", b =>
                {
                    ...
                    b.Property<DateTime>("DataAlteracao")
                        ...
                        .HasDefaultValue(new DateTime(2025, 9, 22, 4, 43, 24, 231, DateTimeKind.Utc).AddTicks(9332))
            ...
            modelBuilder.Entity("AutoGestao.Entidades.Cliente", b =>
                {
                    ...
                    b.Property<DateTime>("DataAlteracao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 9, 22, 4, 43, 24, 231, DateTimeKind.Utc).AddTicks(4072))
                        .HasColumnName("data_alteracao");
            ...
            modelBuilder.Entity("AutoGestao.Entidades.Despesa", b =>
                {
                    ...
                    b.Property<DateTime>("DataAlteracao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 9, 22, 4, 43, 24, 231, DateTimeKind.Utc).AddTicks(9720))
                        .HasColumnName("data_alteracao");
            ...
            modelBuilder.Entity("AutoGestao.Entidades.DespesaTipo", b =>
                {
                    ...
                    b.Property<DateTime>("DataAlteracao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 9, 22, 4, 43, 24, 231, DateTimeKind.Utc).AddTicks(9970))
                        .HasColumnName("data_alteracao");
            ...
            modelBuilder.Entity("AutoGestao.Entidades.Fornecedor", b =>
                {
                    ...
                    b.Property<DateTime>("DataAlteracao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 9, 22, 4, 43, 24, 231, DateTimeKind.Utc).AddTicks(5447))
                        .HasColumnName("data_alteracao");
            ...
            modelBuilder.Entity("AutoGestao.Entidades.Parcela", b =>
                {
                    ...
                    b.Property<DateTime>("DataAlteracao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 9, 22, 4, 43, 24, 231, DateTimeKind.Utc).AddTicks(8936))
                        .HasColumnName("data_alteracao");
            ...
            modelBuilder.Entity("AutoGestao.Entidades.Tarefa", b =>
                {
                    ...
                    b.Property<DateTime>("DataAlteracao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 9, 22, 4, 43, 24, 232, DateTimeKind.Utc).AddTicks(291))
                        .HasColumnName("data_alteracao");
            ...
            modelBuilder.Entity("AutoGestao.Entidades.Veiculos.Veiculo", b =>
                {
                    ...
                    b.Property<DateTime>("DataAlteracao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 9, 22, 4, 43, 24, 231, DateTimeKind.Utc).AddTicks(6732))
                        .HasColumnName("data_alteracao");
            ...
            modelBuilder.Entity("AutoGestao.Entidades.Veiculos.VeiculoDocumento", b =>
                {
                    ...
                    b.Property<DateTime>("DataAlteracao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 9, 22, 4, 43, 24, 231, DateTimeKind.Utc).AddTicks(8054))
                        .HasColumnName("data_alteracao");
            ...
            modelBuilder.Entity("AutoGestao.Entidades.Veiculos.VeiculoFoto", b =>
                {
                    ...
                    b.Property<DateTime>("DataAlteracao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 9, 22, 4, 43, 24, 231, DateTimeKind.Utc).AddTicks(7720))
                        .HasColumnName("data_alteracao");
            ...
            modelBuilder.Entity("AutoGestao.Entidades.Venda", b =>
                {
                    ...
                    b.Property<DateTime>("DataAlteracao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 9, 22, 4, 43, 24, 231, DateTimeKind.Utc).AddTicks(8483))
                        .HasColumnName("data_alteracao");
            ...
            modelBuilder.Entity("AutoGestao.Entidades.Vendedor", b =>
                {
                    ...
                    b.Property<DateTime>("DataAlteracao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 9, 22, 4, 43, 24, 231, DateTimeKind.Utc).AddTicks(4684))
                        .HasColumnName("data_alteracao");
